...
{
  "$end", "error", "$undefined", "COMMENT", "INTDCL", "PRINT", "ASSIGN",
  "PLUS", "MINUS", "TIMES", "DIVIDE", "INUM", "ID", "$accept", "prog",
  "dcls", "dcl", "stmts", "stmt", "expr", "denom", "val", YY_NULLPTR
};
#endif
...
{
       1,     2,     6,    -5,     1,   -12,   -12,     3,     7,   -12,
      -5,   -12,   -12,     0,   -12,   -12,   -12,   -12,    -6,     0,
...
{
       4,     0,     0,     7,     4,     5,     1,     0,     0,     2,
       7,     3,     9,     0,     6,    17,    16,     8,    14,     0,
       0,     0,     0,    10,    11,    12,    13,    15
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -12,   -12,    12,   -12,     8,   -12,   -11,   -12,    -3
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4,     9,    10,    17,    26,    18
};
...
{
       7,    19,    20,    21,    22,     1,     6,     8,    23,    24,
      25,    15,    16,    13,     5,    12,    11,     0,    14,    27
};

static const yytype_int8 yycheck[] =
{
       5,     7,     8,     9,    10,     4,     0,    12,    19,    20,
      21,    11,    12,     6,    12,    12,     4,    -1,    10,    22
};
...
{
       0,     4,    14,    15,    16,    12,     0,     5,    12,    17,
      18,    15,    12,     6,    17,    11,    12,    19,    21,     7,
       8,     9,    10,    19,    19,    19,    20,    21
};
